...
use FOND\AnnonceBundle\Entity\Annonce;
...
class AnnonceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $annonces = $em->getRepository('FONDAnnonceBundle:Annonce')->findAll();
    ...
    {
        $annonce = new Annonce();
        $form = $this->createForm('FOND\AnnonceBundle\Form\AnnonceType', $annonce);
    ...
    {
        $deleteForm = $this->createDeleteForm($annonce);
        $editForm = $this->createForm('FOND\AnnonceBundle\Form\AnnonceType', $annonce);
